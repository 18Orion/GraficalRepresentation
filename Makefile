#############################################################################
# Makefile for building: Grafica
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  Grafica.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Grafica.pro
#############################################################################
...
Grafica: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Grafica.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/Grafica/bin || mkdir -p $(INSTALL_ROOT)/opt/Grafica/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/Grafica/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/Grafica/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/Grafica/bin/ 
